...
public class ChurchScrapperApp {
    ...
    public static void main(String[] args) {
        ...
        leftPanel.getSearchButton().addActionListener(new ChurchDataScrapper(
            leftPanel, rightPanel.getTableModel(), rightPanel.getCityHeader()));

        // Action Listener for the Export Button
        rightPanel.getExportButton().addActionListener(e -> 
            CSVExporter.exportTableDataToCSV(rightPanel.getTableModel(), leftPanel.getCityFieldText())
        );
